...
namespace EndToEndTests
{
    ...
    public class AddOffer135_BypassOn_MarketClosed_HTA_8003_Future_Working : BaseWebAiiTest
    {
        ...
        public void AddOffer_BypassOn_MarketOpen_HTA_5001_Working_CodedStep3()
        {
            ...
            Manager.Desktop.KeyBoard.TypeText("8,003", 50, 100, true);
        ...
        public void AddOffer_BypassOn_MarketOpen_HTA_5001_Working_CodedStep4()
        {
            ...
            string date = DateTime.Now.Date.AddDays(7).ToString("yyyy-MM-dd");
