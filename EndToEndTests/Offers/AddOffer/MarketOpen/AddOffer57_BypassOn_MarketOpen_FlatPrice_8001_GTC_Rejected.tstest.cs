...
namespace EndToEndTests
{
    ...
    public class AddOffer57_BypassOn_MarketOpen_FlatPrice_8001_GTC_Rejected : BaseWebAiiTest
    {
        ...
        public void AddOffer115_BypassOn_MarketClosed_FlatPrice_2000_GTC_Working_CodedStep()
        {
            ...
            Manager.Desktop.KeyBoard.TypeText("100000", 50, 100, true);
            
        }
    
        [CodedStep(@"Enter text '2,000' in 'QuantityText'")]
        public void AddOffer115_BypassOn_MarketClosed_FlatPrice_5001_GTC_Working_CodedStep()
        {
            ...
            Manager.Desktop.KeyBoard.TypeText("8,001", 50, 100, true);
            
        }
    
        [CodedStep(@"Verify 'TextContent' 'Contains' '$10.0100' on 'cashpriceText'")]
        public void AddOffer53_BypassOn_MarketOpen_FlatPrice_8001_GTC_Rejected_CodedStep()
        {
            // Verify 'TextContent' 'Contains' '$10.0100' on 'cashpriceText'
            Pages.TransactionsHRVYSTHEDGE.cashpriceText.AssertContent().TextContent(ArtOfTest.Common.StringCompareType.Contains, "$100,000.0000");
