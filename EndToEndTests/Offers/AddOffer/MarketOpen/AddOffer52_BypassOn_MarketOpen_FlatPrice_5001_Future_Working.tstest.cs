...
namespace EndToEndTests
{
    ...
    public class AddOffer52_BypassOn_MarketOpen_FlatPrice_5001_Future_Working : BaseWebAiiTest
    {
        ...
        public void AddOffer115_BypassOn_MarketClosed_FlatPrice_2000_GTC_Working_CodedStep()
        {
            ...
            Manager.Desktop.KeyBoard.TypeText("10.01", 50, 100, true);
        ...
        public void AddOffer51_BypassOn_MarketOpen_FlatPrice_5001_Today_Working_CodedStep()
        {
        ...
        [CodedStep(@"Verify 'TextContent' 'Contains' '$5.0100' on 'cashpriceText'")]
        public void AddOffer51_BypassOn_MarketOpen_FlatPrice_5001_Today_Working_CodedStep1()
        {
            // Verify 'TextContent' 'Contains' '$5.0100' on 'cashpriceText'
            Pages.TransactionsHRVYSTHEDGE.cashpriceText.AssertContent().TextContent(ArtOfTest.Common.StringCompareType.Contains, "$10.0100");
